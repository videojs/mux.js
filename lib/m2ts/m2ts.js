    ...
    ({
      ...
      pes: function() {
        ...
        case m2tsStreamTypes.H264_STREAM_TYPE:
          ...
          streamType = 'video';
          break;
        case m2tsStreamTypes.ADTS_STREAM_TYPE:
          stream = audio;
          streamType = 'audio';
          break;
        case m2tsStreamTypes.METADATA_STREAM_TYPE:
...
module.exports = {
  ...
  CaptionStream: require('./caption-stream.js'),
  MetadataStream: require('./metadata-stream.js')
};
