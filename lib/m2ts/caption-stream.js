...
var CaptionStream = function(options) {
  ...
  if (this.parse708captions_) {
    this.cc708Stream_ = new Cea708Stream({encoding: options.encoding}); // eslint-disable-line no-use-before-define
  }
...
var Cea708Stream = function(options) {
  ...
  // Try to setup a TextDecoder if an `encoding` option was provided
 ...
 */
Cea708Stream.prototype.createTextDecoder = function(encoding) {
...
Cea708Stream.prototype.handleText = function(i, service, isExtended) {
  ...
  // Use the TextDecoder if one was created
  if (this.textDecoder_) {
    ...
    char = this.textDecoder_.decode(new Uint8Array(charCodeArray));
  } else {
