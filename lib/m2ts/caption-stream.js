...
Cea708Stream.prototype.handleText = function(i, service, isExtended) {
  ...
  if (win.newLine && win.text !== '') {
    win.text += '\n';
  }
  win.newLine = false;
  win.text += get708CharFromCode(extended | b);
 ...
 * @return {Integer}          New index after parsing
 */
Cea708Stream.prototype.backspace = function(i, service) {
  var win = service.currentWindow;

  if (win.text.length > 0) {
    win.text = win.text.substr(0, win.text.length - 1);
  }
