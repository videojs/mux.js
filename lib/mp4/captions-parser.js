...
var CaptionParser = function() {
  ...
  this.init = function() {
     ...
     **/
    this.parse = function(init, segment) {
      var parsedData = parseEmbeddedCaptions(init, segment);

      if (parsedData === null || !parsedData.seiNals) {
        return null;
      }

      // Set timescale for the CaptionParser
      trackTimescale = parsedData.timescale;
