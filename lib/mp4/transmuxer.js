 ...
 * @param options.streamSelection {object} streamSelection select only one stream (don't mux)
 * @param options.streamSelection.type {"audio"|"video"} select only video or audio
 * @param options.streamSelection.pid {integer} in conjunction with streamSelection.type="audio" select a specific
 *        audio by pid.
 */
...
Transmuxer = function(options) {
  ...
  this.setupTsPipeline = function() {
    ...
    pipeline.parseStream = new m2ts.TransportParseStream(options);
