...
CoalesceStream.prototype.flush = function(flushSource) {
  ...
  event.serializedTracks = mp4Utils.serializeTracks(this.pendingTracks);

  // Create a new typed array large enough to hold all of the tracks
