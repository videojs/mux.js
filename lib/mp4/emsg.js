...
var parseEmsgBox = function(boxData) {
    ...
    if (version === 0) {
        ...
        // TODO: check these hard coded offsets for validity.
        ...
        var dv = new DataView(boxData);
        timescale = dv.getUint32(4);
        presentation_time = dv.getBigUint64(8);
        event_duration = dv.getUint32(16);
        id = dv.getUint32(20);
...
var getEmsgData = function(data, ptOffset) {
    ...
    emsgBoxes.forEach(function(boxData) {
        ...
        var pts = scaleTime(parsedBox.presentation_time, 
                            parsedBox.timescale, 
