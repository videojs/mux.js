...
compositionStartTime = function(timescales, fragment) {
  ...
  if (trafBoxes && trafBoxes.length) {
    ...
    var tfhd = parseTfhd(findBox(trafBoxes[0], ['tfhd'])[0]);
    var trun = parseTrun(findBox(trafBoxes[0], ['trun'])[0]);
    var tfdt = parseTfdt(findBox(trafBoxes[0], ['tfdt'])[0]);
    ...
    if (trun && trun.samples && trun.samples.length) {
      compositionTimeOffset = trun.samples[0].compositionTimeOffset || 0;
    }
  }
