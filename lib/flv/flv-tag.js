...
var FlvTag; // (type:uint, extraData:Boolean = false) extends ByteArray
...
FlvTag = function (type, extraData) {
  ...
  this.finalize = function () {
    ...
    this.frameTime = FlvTag.frameTime(this.bytes); // if bytes.bytelength isn't equal to this.length, handle error
