  ...
  elementaryStream.on('data', function (data) {
    ...
    if (data.type === 'metadata') {
      ...
      if (videoTrack && !videoSegmentStream) {
        ...
        videoSegmentStream = new VideoSegmentStream(videoTrack); // Set up the final part of the video pipeline
      ...
      if (audioTrack && !audioSegmentStream) {
        ...
        coalesceStream.numberOfTracks++;
        audioSegmentStream = new AudioSegmentStream(audioTrack); // Set up the final part of the audio pipeline
...
Transmuxer.prototype = new Stream(); // forward compatibility
