...
var _frameUtils = require("../mp4/frame-utils");
...
var VideoSegmentStream = function VideoSegmentStream(track, options) {
  ...
  this.push = function (nalUnit) {
    _trackDecodeInfo.default.collectDtsInfo(track, nalUnit);
  ...
  this.processNals_ = function (cacheLastFrame) {
    ...
    var frames = (0, _frameUtils.groupNalsIntoFrames)(nalUnits);
    ...
    if (ensureNextFrameIsKeyFrame) {
      gops = (0, _frameUtils.groupFramesIntoGops)(frames);
    ...
    for (i = 0; i < frames.length; i++) {
      var frame = frames[i];
      track.samples = (0, _frameUtils.generateSampleTableForFrame)(frame);
      var mdat = (0, _mp4Generator.mdat)((0, _frameUtils.concatenateNalDataForFrame)(frame));

      _trackDecodeInfo.default.clearDtsInfo(track);

      _trackDecodeInfo.default.collectDtsInfo(track, frame);
      ...
      var moof = (0, _mp4Generator.moof)(sequenceNumber, [track]);
      sequenceNumber++;
      track.initSegment = (0, _mp4Generator.initSegment)([track]);
...
var _default = VideoSegmentStream;
