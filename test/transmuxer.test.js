...
QUnit.test('parses correct ID3 tag size', function() {
  ...
  packetStream[9] = 63;
  QUnit.equal(parser(packetStream),73, 'ParseID3 correctly parsed a header without a footer');
});
...
QUnit.test('parses correct ADTS Frame size', function() {
  ...
  packetStream[4] = 29;
  packetStream[5] = 255;
  QUnit.equal(parser(packetStream),239, 'ParseADTS correctly parsed framesize');
});
