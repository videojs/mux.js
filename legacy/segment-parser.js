...
SegmentParser = function(options) {
  ...
  SegmentParser.prototype.init.call(this);
  ...
  aacStream = new muxjs.mp2t.AacStream();
  h264Stream = new muxjs.mp2t.H264Stream();
...
/*    self.videoTags = event.tags.videoTags;
    self.audioTags = event.tags.audioTags;
    this.metadata = event.metadata;
    this.captions = event.captions;*/
  });
...
SegmentParser.prototype = new muxjs.Stream();

// forward compatibility
muxjs.mp2t = muxjs.mp2t || {};
muxjs.SegmentParser = SegmentParser;
